...
macro(relic_shared_library TARGET SOURCE LIBNAME)
  ...
  set_target_properties(${TARGET}-shared PROPERTIES IMPORTED_LOCATION ${PROJECT_SOURCE_DIR}/deps/lib/${CMAKE_SHARED_LIBRARY_PREFIX}${LIBNAME}${CMAKE_SHARED_LIBRARY_SUFFIX})
